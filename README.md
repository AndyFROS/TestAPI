...
### Этот репозиторий предназначен для выполнения практической работы и не несет в себе каких то рабочих методов для взаимодействия с информацией о погоде, тут только описаны методы взимодействия API, которые подключены к шаблонному коду, в котором нет практической пользы.
